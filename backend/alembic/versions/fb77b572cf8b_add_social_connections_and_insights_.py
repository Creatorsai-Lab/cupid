...
down_revision: str | Sequence[str] | None = "27bc25f94739"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["connection_id"], ["social_connections.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "connection_id", "snapshot_date", name="uq_connection_date"
        ),
    )
    op.create_index(
        op.f("ix_insights_snapshots_connection_id"),
        "insights_snapshots",
        ["connection_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_top_content_connection_id"),
        "top_content",
        ["connection_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_insights_snapshots_connection_id"), table_name="insights_snapshots"
    )
    op.drop_table("insights_snapshots")
    op.drop_index(
        op.f("ix_social_connections_user_id"), table_name="social_connections"
    )
