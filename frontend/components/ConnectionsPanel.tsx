  ...
  return (
    <section className="space-y-4">
      ...
      >
        ...
        {!loading && !youtubeConnection && (
          <button
            ...
            disabled={connecting}
            className="flex items-center gap-1.5 rounded-md px-3.5 py-1.5 text-sm text-white disabled:opacity-50"
        ...
        {!loading && youtubeConnection && (
          <button
            ...
            className="flex items-center gap-1.5 rounded-md px-3 py-1.5 text-sm hover:bg-red-50"
      ...
      >
        ...
        >
          <span style={{ color: "var(--color-muted)", fontSize: "10px", fontWeight: 600 }}>in</span>
        </div>
