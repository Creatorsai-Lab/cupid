        ...
        <ProtectedRoute>
            ...
            >
                <div className="max-w-4xl mx-auto">
                    ...
                    {error && !loading && (
                        <ErrorState message={error} onRetry={() => loadHistory(0, false)} />
                    )}
                    ...
                    {hasMore && !loading && (
                        <div className="flex justify-center mt-8">
                            <button
                                ...
                                className="flex items-center gap-2 px-5 py-2 text-sm rounded-md border transition-colors disabled:opacity-50"
                                style={{
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <button
                        onClick={onClose}
                        className="p-2 rounded-md hover:bg-[var(--color-background)] flex-shrink-0"
...
function FullVariant({ variant, index }: { variant: HistoryVariant; index: number }) {
    ...
    return (
        ...
        >
            ...
            <p
                className="text-sm leading-relaxed whitespace-pre-line p-4"
                style={{ color: "var(--color-text)", fontFamily: "var(--font-body)" }}
            >
                {variant.content}
            </p>
...
function EmptyState() {
    return (
        <div
            className="rounded-2xl border-2 border-dashed flex flex-col items-center justify-center py-16 px-8 text-center"
            style={{ borderColor: "var(--color-border)" }}
        >
            <div
            ...
            <p
                ...
                style={{ color: "var(--color-muted)", fontFamily: "var(--font-body)" }}
            >
                Head to the Create page and generate your first set of posts. They'll show up here automatically.
            </p>
            <a
                href="/create"
        ...
        <div className="space-y-4">
            {[0, 1, 2].map((i) => (
                <div
                    ...
                    style={{ borderColor: "var(--color-border)" }}
                >
                    <div className="h-5 w-2/3 rounded bg-[var(--color-primary-tint,#fff6ed)] mb-4" />
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        {[0, 1, 2].map((j) => (
                            <div
                                key={j}
                                className="h-36 rounded-xl bg-[var(--color-primary-tint,#fff6ed)]"
                            />
                        ))}
                    </div>
                </div>
