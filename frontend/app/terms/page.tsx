    ...
    <main className="max-w-4xl w-full mx-auto flex-1 transition-all duration-500 p-3">
      ...
      <div className="space-y-8 text-sm leading-relaxed text-[var(--color-text)]">
        <section className="space-y-2">
          ...
          <p>
            By creating an account or using Cupid, you agree to these terms. If
        ...
        <section className="space-y-2">
          ...
          <p>
            You&apos;re responsible for keeping your login secure and for activity
            under your account. Provide accurate information and don&apos;t share
            your credentials.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            Don&apos;t use Cupid to create unlawful, harmful, hateful, or
            deceptive content, to infringe others&apos; rights, or to abuse the
            platform or its providers. We may suspend accounts that violate these
            rules.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            You own the content you create with Cupid. You grant us the limited
            rights needed to operate the service — for example, to store, process,
            and display your content back to you.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            Cupid uses AI and can make mistakes. Generated content may be
            inaccurate or incomplete — always review it before publishing. You are
            responsible for what you choose to post.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            ...
            extent permitted by law, Cupid is not liable for indirect or
