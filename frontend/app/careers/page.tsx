    ...
    <main className="max-w-5xl w-full mx-auto flex-1 transition-all duration-500 p-3">
      ...
      <div className="space-y-8 text-sm leading-relaxed text-[var(--color-text)]">
        <section className="space-y-2">
          ...
          <p>
            We&apos;re a small team building at the intersection of AI agents and
            the creator economy. You&apos;ll ship real features to real creators
            every week, own problems end to end, and see your work in production
            fast.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <div className="p-5 rounded-xl border border-[var(--color-border)] text-[var(--color-muted)]">
            No open positions right now — but we&apos;re always glad to meet
            sharp builders. If you love this space, tell us what you&apos;d want
            to work on.
          </div>
        </section>
